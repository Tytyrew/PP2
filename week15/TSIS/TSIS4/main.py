...
import json
import os
import week15.TSIS.TSIS4.db as db
from week15.TSIS.TSIS4.game import run_game
from week15.TSIS.TSIS4.config import *
...
def screen_name(screen):
    ...
    while True:
        screen.fill(DARK)
        write(screen, "SNAKE GAME", WIDTH//2, 100, 40, BLUE)
